...
# puts csv
byebug
aur1 = AgencyUpdateRequest.create(name: 'ABC', nombre: 'abc', address: '201 W Main st.', city: 'Durham', state: 'NC', zipcode: '27701',
...
aur2 = AgencyUpdateRequest.create(name: 'XYZ', nombre: 'xyz', address: '3100 Duraleigh Rd STE 300', city: 'Raleigh', state: 'NC', zipcode: '27612',
